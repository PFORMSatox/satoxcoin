...
This guide describes how to build satoxcoind, command-line utilities, and GUI on macOS.
...
``` bash
/Users/${USER}/Library/Application Support/Satoxcoin/
```
...
chmod 600 "/Users/${USER}/Library/Application Support/Satoxcoin/satoxcoin.conf"
```
