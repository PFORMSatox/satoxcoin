...
Assumeutxo is a feature that allows fast bootstrapping of a validating satoxcoind
instance.
...
```
$ satoxcoin-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ satoxcoin-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
