# Fuzzing Satoxcoin Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing Satoxcoin Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
## Overview of Satoxcoin Core fuzzing
...
It is possible to specify `satoxcoind` arguments to the `fuzz` executable.
...
The project's collection of seed corpora is found in the [`satoxcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo.

To fuzz `process_message` using the [`satoxcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) seed corpus:
...
an instrumentalized libc++, then using it to build [Satoxcoin Core dependencies
from source](../depends/README.md) and finally the Satoxcoin Core fuzz binary
...
If you find coverage increasing inputs when fuzzing you are highly encouraged to submit them for inclusion in the [`satoxcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo.

Every single pull request submitted against the Satoxcoin Core repo is automatically tested against all inputs in the [`satoxcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Satoxcoin Core more robust.
...
# Fuzzing Satoxcoin Core using afl++

## Quickstart guide

To quickly get started fuzzing Satoxcoin Core using [afl++](https://github.com/AFLplusplus/AFLplusplus):
...
# Fuzzing Satoxcoin Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing Satoxcoin Core using [Honggfuzz](https://github.com/google/honggfuzz):
...
Satoxcoin Core participates in Google's [OSS-Fuzz](https://github.com/google/oss-fuzz/tree/master/projects/bitcoin-core)
...
Satoxcoin Core follows its [security disclosure policy](https://bitcoincore.org/en/security-advisories/),
