# Support for Output Descriptors in Satoxcoin Core

Many Satoxcoin Core RPCs support Output Descriptors. This is a simple language
...
transactions related to the multisig. Lastly, it is not recommended to use anything other than a Satoxcoin Core descriptor wallet to serve as your
...
existing Satoxcoin Core wallets, a convenience function `combo` is
...
All RPCs in Satoxcoin Core will include the checksum in their output. Only
