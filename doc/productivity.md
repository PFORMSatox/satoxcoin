...
```sh
cmake --build build --target satoxcoind satoxcoin-cli
cmake --build build --target satoxcoin-qt
cmake --build build --target bench_satoxcoin
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:satoxcoin/satoxcoin.git
```
...
> e.g. github.com/satoxcoin/satoxcoin.git or for the GUI github.com/satoxcoin-core/gui
