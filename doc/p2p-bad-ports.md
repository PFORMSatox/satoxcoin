When Satoxcoin Core automatically opens outgoing P2P connections, it chooses
...
and usually require authentication. A connection attempt (by Satoxcoin Core,
...
Below is a list of "bad" ports which Satoxcoin Core avoids when choosing a peer to
