...
The Satoxcoin Core daemon can be configured to act as a trusted "border
router", implementing the satoxcoin wire protocol and relay, making
...
The ZeroMQ feature in Satoxcoin Core requires the ZeroMQ API >= 4.0.0
...
For instance:
    ...
    $ satoxcoind -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubhashtx=tcp://192.168.1.2:28332 \
               -zmqpubhashblock="tcp://[::1]:28333" \
               -zmqpubrawtx=unix:/tmp/satoxcoind.tx.raw \
...
From the perspective of satoxcoind, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into satoxcoind directly. Furthermore, no information is
...
using. Satoxcoind appends an up-counting sequence number to each
