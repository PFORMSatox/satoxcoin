...
class BIP66Test(SatoxcoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # satoxcoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and satoxcoind produces more specific reject
            # reasons.
