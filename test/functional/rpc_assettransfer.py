...
class AssetTransferTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.sync_all()
        self.generate(self.nodes[1], 250)
        self.sync_all()
        ...
        address0 = n0.getnewaddress("", "legacy")
        ...
        n0_satox_change = n0.getnewaddress("", "legacy")
        n0_asset_change = n0.getnewaddress("", "legacy")

        n0.transfer(asset_name="TRANSFER_TEST", qty=200, to_address=n1_address, message='', expire_time=0, change_address=n0_satox_change, asset_change_address=n0_asset_change)
        ...
        n0.transferfromaddress(asset_name="TRANSFER_TEST", from_address=n0_from_address, qty=200, to_address=n1_address, message='', expire_time=0, satox_change_address=n0_satox_change, asset_change_address=n0_asset_change)
        ...
        n0_new_address = n0.getnewaddress("", "legacy")
        n0.transfer(asset_name="TRANSFER_TEST", qty=200, to_address=n0_new_address, message='', expire_time=0, change_address=n0_satox_change, asset_change_address=n0_asset_change)
        ...
        n0.transferfromaddresses(asset_name="TRANSFER_TEST", from_addresses=n0_from_addresses, qty=450, to_address=n1_address, message='', expire_time=0, satox_change_address=n0_satox_change, asset_change_address=n0_asset_change)
        ...
        assert_raises_rpc_error(-6, "Insufficient asset funds", n0.transferfromaddresses, "TRANSFER_TEST", n0_from_addresses, 450, n1_address, '', 0, n0_satox_change, n0_asset_change)
...
if __name__ == '__main__':
    AssetTransferTest(__file__).main()
