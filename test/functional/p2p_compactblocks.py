...
# TestNode: A peer we use to send messages to satoxcoind, and store responses.
...
class CompactBlocksTest(SatoxcoinTestFramework):
    ...
    # This test actually causes satoxcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that satoxcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for satoxcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # satoxcoind will not send blocktxn responses for blocks whose height is
