...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the SatoxcoinTestFramework
    pass

class ExampleTest(SatoxcoinTestFramework):
    # Each functional test is a subclass of the SatoxcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        SatoxcoinTestFramework class so other tests can use it."""
