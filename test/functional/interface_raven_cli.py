...
class TestSatoxcoinCli(SatoxcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `satoxcoin-cli getinfo`")
        ...
        self.log.info("Compare responses from `satoxcoin-cli -getinfo` and the RPCs data is retrieved from.")
