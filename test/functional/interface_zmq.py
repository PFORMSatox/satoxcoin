...
import os
import struct
from test_framework.test_framework import SatoxcoinTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(SatoxcoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that satoxcoin has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("satoxcoind has not been built with zmq enabled.")
