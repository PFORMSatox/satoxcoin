...
By default, satoxcoind will dump mempool on shutdown and
...
class MempoolPersistTest(SatoxcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give satoxcoind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent satoxcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
