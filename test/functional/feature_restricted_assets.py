...
class RestrictedAssetsTest(BitcoinTestFramework):
    def set_test_params(self):
        self.setup_clean_chain = True
        self.num_nodes = 2
        self.uses_wallet = True
        self.wallet_names = ["w0", "w0"]
        self.extra_args = [['-assetindex'], ['-assetindex']]


    def generate(self, node, nblocks, address=None, sync=True):
        if address is None:
            # Satoxcoin regtest addresses use a different prefix than the BTC
            # deterministic test key, so ask the node for a real legacy address.
    ...
    def issuerestrictedasset(self):
        ...
        qty = 10000
        verifier = "true"
        to_address = n0.getnewaddress("", "legacy")
        ...
        assert_raises_rpc_error(None, "Invalid to_address", n0.issuerestrictedasset, asset_name, qty, verifier, "garbageaddress")
    ...
    def issuerestrictedasset_full(self):
        ...
        verifier = "true"
        to_address = n0.getnewaddress("", "legacy")
        change_address = n0.getnewaddress("", "legacy")
        units = 2
        reissuable = False
        has_ipfs = True
        ...
        # valid params
        assert_raises_rpc_error(None, "Invalid change address", n0.issuerestrictedasset, asset_name, qty, verifier, to_address, "garbagechangeaddress")
    ...
    def reissuerestrictedasset_full(self):
        ...
        orig_qty = 10000
        orig_verifier = "true"
        orig_to_address = n0.getnewaddress("", "legacy")
        ...
        n1.issuerestrictedasset(foreign_asset_name, 1, "true", n1.getnewaddress("", "legacy"))
        self.generate(n1, 1)
        self.sync_all()
    ...
    def issue_qualifier_asset_full(self):
        ...
        assert_raises_rpc_error(None, "Qualifier asset amount must be between 1 and 10", n0.issuequalifierasset, asset_name, 0)
        assert_raises_rpc_error(None, "Invalid Satoxcoin address", n0.issuequalifierasset, asset_name, qty, "garbageaddress")
        assert_raises_rpc_error(None, "Invalid change address", n0.issuequalifierasset, asset_name, qty, to_address, "gargabechangeaddress")
        assert_raises_rpc_error(None, "Invalid IPFS/Txid hash", n0.issuequalifierasset, asset_name, qty, to_address, change_address, True, "garbagehash")
    ...
    def transferqualifier(self):
        ...
        n0_change_address = n0.getnewaddress("", "legacy")
        n1_address = n1.getnewaddress("", "legacy")
        ...
        assert_raises_rpc_error(None, "Only qualifier assets", n0.transferqualifier, nonqualifier_asset_name, 1, n1_address)
        assert_raises_rpc_error(None, "Invalid to_address", n0.transferqualifier, asset_name, 1, "garbageaddress")
        assert_raises_rpc_error(None, "Invalid change address", n0.transferqualifier, asset_name, 1, n1_address, "garbagechangeaddress")
        assert_raises_rpc_error(None, "Invalid IPFS/Txid hash", n0.transferqualifier, asset_name, 1, n1_address, n0_change_address, "garbagemessage")
    ...
    def tagging(self):
        ...
        tag = "#TAG"
        address = n0.getnewaddress("", "legacy")
        change_address = n0.getnewaddress("", "legacy")
        ...
        qty = 1000
        verifier = tag
        issue_address = n0.getnewaddress("", "legacy")
        n0.issue(base_asset_name)
        ...
        satox_change_address = n0.getnewaddress("", "legacy")
        asset_change_address = n0.getnewaddress("", "legacy")
        n0.addtagtoaddress(tag, satox_change_address)
        n0.addtagtoaddress(tag, asset_change_address)
        self.generate(n0, 1)
        assert_raises_rpc_error(-8, "bad-txns-null-verifier-address-failed-verification", n0.transfer, asset_name, 100, address, "", 0, satox_change_address, asset_change_address)
        n0.removetagfromaddress(tag, satox_change_address)
        n0.removetagfromaddress(tag, asset_change_address)
        self.generate(n0, 1)
        ##

        assert_raises_rpc_error(None, "Invalid Satoxcoin address", n0.addtagtoaddress, tag, "garbageaddress")
        assert_raises_rpc_error(None, "Invalid change address", n0.addtagtoaddress, tag, address, "garbagechangeaddress")
        ...
        # special case: make sure transfer fails if the asset change address isn't verified (even if the satox change address is)
        satox_change_address = n0.getnewaddress("", "legacy")
        asset_change_address = n0.getnewaddress("", "legacy")
        assert_raises_rpc_error(-20, "bad-txns-null-verifier-address-failed-verification", n0.transfer, asset_name, 100, address, "", 0, satox_change_address, asset_change_address)
        n0.addtagtoaddress(tag, satox_change_address)
        self.generate(n0, 1)
        assert_raises_rpc_error(-20, "bad-txns-null-verifier-address-failed-verification", n0.transfer, asset_name, 100, address, "", 0, satox_change_address, asset_change_address)
        n0.removetagfromaddress(tag, satox_change_address)
        ...
        assert_raises_rpc_error(None, "Invalid Satoxcoin address", n0.removetagfromaddress, tag, "garbageaddress")
        assert_raises_rpc_error(None, "Invalid change address", n0.removetagfromaddress, tag, address, "garbagechangeaddress")
    ...
    def freezing(self):
        ...
        verifier = "true"
        address = n0.getnewaddress("", "legacy")
        safe_address = n0.getnewaddress("", "legacy")
        satox_change_address = n0.getnewaddress("", "legacy")
        ...
        change_address = n0.getnewaddress("", "legacy")
        n0.transferfromaddress(asset_name, address, 1000, n1.getnewaddress("", "legacy"), "", "", "", change_address)
        self.generate(n0, 1)
        self.sync_all()
        ...
        assert_raises_rpc_error(None, "Invalid Satoxcoin address", n0.freezeaddress, asset_name, "garbageaddress")
        assert_raises_rpc_error(None, "Invalid change address", n0.freezeaddress, asset_name, address, "garbagechangeaddress")

        n0.freezeaddress(asset_name, address, satox_change_address)
        self.generate(n0, 1)

        assert_raises_rpc_error(-32600, "freeze-address-when-already-frozen", n0.freezeaddress, asset_name, address, satox_change_address)
        ...
        assert_raises_rpc_error(-8, "No asset outpoints are selected from the given address", n0.transferfromaddress, asset_name, address, 1000, n1.getnewaddress("", "legacy"))

        assert_raises_rpc_error(None, "Invalid Satoxcoin address", n0.unfreezeaddress, asset_name, "garbageaddress")
        assert_raises_rpc_error(None, "Invalid change address", n0.unfreezeaddress, asset_name, address, "garbagechangeaddress")

        n0.unfreezeaddress(asset_name, address, satox_change_address)
        self.generate(n0, 1)

        assert_raises_rpc_error(-32600, "unfreeze-address-when-not-frozen", n0.unfreezeaddress, asset_name, address, satox_change_address)
    ...
    def global_freezing(self):
        ...
        assert_raises_rpc_error(None, "Invalid change address", n0.freezerestrictedasset, asset_name, "garbagechangeaddress")

        n0.freezerestrictedasset(asset_name, satox_change_address)  # Can only freeze once!
        assert_raises_rpc_error(-26, "Freezing transaction already in mempool", n0.freezerestrictedasset, asset_name, satox_change_address)
        self.generate(n0, 1)
        assert_raises_rpc_error(None, "global-freeze-when-already-frozen", n0.freezerestrictedasset, asset_name, satox_change_address)

        # post-freeze validation
        assert_contains(asset_name, n0.listglobalrestrictions())
        assert n0.checkglobalrestriction(asset_name)
        assert_raises_rpc_error(-8, "restricted asset has been globally frozen", n0.transferfromaddress, asset_name, address, 1000, n1.getnewaddress("", "legacy"))
        assert_raises_rpc_error(None, "Invalid change address", n0.unfreezerestrictedasset, asset_name, "garbagechangeaddress")

        n0.unfreezerestrictedasset(asset_name, satox_change_address)  # Can only un-freeze once!
        assert_raises_rpc_error(-26, "Unfreezing transaction already in mempool", n0.unfreezerestrictedasset, asset_name, satox_change_address)
        self.generate(n0, 1)
        assert_raises_rpc_error(None, "global-unfreeze-when-not-frozen", n0.unfreezerestrictedasset, asset_name, satox_change_address)
    ...
    def run_test(self):
        self.log.info("Mining SATOX for node[0] and funding node[1]...")
        self.generate(self.nodes[0], 250)
        self.sync_all()
        self.nodes[0].sendtoaddress(self.nodes[1].getnewaddress("", "legacy"), 25000)
...
if __name__ == '__main__':
    RestrictedAssetsTest(__file__).main()
