...
#ifndef SATOXCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define SATOXCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // SATOXCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
