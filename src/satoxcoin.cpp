...
Options:
  -m, --multiprocess     Run multiprocess binaries satoxcoin-node, satoxcoin-gui.
  -M, --monolithic       Run monolithic binaries satoxcoind, satoxcoin-qt. (Default behavior)
  -v, --version          Show version information
  -h, --help             Show full help message

Commands:
  gui [ARGS]     Start GUI, equivalent to running 'satoxcoin-qt [ARGS]' or 'satoxcoin-gui [ARGS]'.
  node [ARGS]    Start node, equivalent to running 'satoxcoind [ARGS]' or 'satoxcoin-node [ARGS]'.
  rpc [ARGS]     Call RPC method, equivalent to running 'satoxcoin-cli -named [ARGS]'.
  wallet [ARGS]  Call wallet command, equivalent to running 'satoxcoin-wallet [ARGS]'.
  tx [ARGS]      Manipulate hex-encoded transactions, equivalent to running 'satoxcoin-tx [ARGS]'.
...
Additional less commonly used commands:
  ...
  chainstate [ARGS] Run bitcoin kernel chainstate util, equivalent to running 'satoxcoin-chainstate [ARGS]'.
...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        if (cmd.show_help || cmd.command.empty()) {
            ...
            args.emplace_back(UseMultiprocess(cmd) ? "satoxcoin-gui" : "satoxcoin-qt");
        } else if (cmd.command == "node") {
            args.emplace_back(UseMultiprocess(cmd) ? "satoxcoin-node" : "satoxcoind");
        } else if (cmd.command == "rpc") {
            args.emplace_back("satoxcoin-cli");
            // Since "satoxcoin rpc" is a new interface that doesn't need to be
            ...
            args.emplace_back("satoxcoin-util");
        } else {
...
//! Execute the specified satoxcoind, satoxcoin-qt or other command line in `args`
...
//!             be a relative path to a satoxcoind, satoxcoin-qt or other executable
