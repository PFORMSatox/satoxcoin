 ...
 */
#ifndef SATOXCOIN_UTIL_H
#define SATOXCOIN_UTIL_H
...
extern const char *const SATOXCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("satoxcoin-%s", name);
