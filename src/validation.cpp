...
#if defined(NDEBUG)
# error "Satoxcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Satoxcoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache, bool test_accept)
{
...

    {
        ...
        // Note: the deprecated and unsafe -promiscuousmempoolflags option has
        // been removed. Non-standard script flags are no longer accepted for
        // mempool acceptance.
...
void ThreadScriptCheck() {
    RenameThread("satoxcoin-scriptch");
