...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(SatoxcoinUnits::RVN),
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(SatoxcoinUnits::formatWithUnit(unit, balance, false, SatoxcoinUnits::separatorAlways));
    ui->labelUnconfirmed->setText(SatoxcoinUnits::formatWithUnit(unit, unconfirmedBalance, false, SatoxcoinUnits::separatorAlways));
    ui->labelImmature->setText(SatoxcoinUnits::formatWithUnit(unit, immatureBalance, false, SatoxcoinUnits::separatorAlways));
    ui->labelTotal->setText(SatoxcoinUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, SatoxcoinUnits::separatorAlways));
    ui->labelWatchAvailable->setText(SatoxcoinUnits::formatWithUnit(unit, watchOnlyBalance, false, SatoxcoinUnits::separatorAlways));
    ui->labelWatchPending->setText(SatoxcoinUnits::formatWithUnit(unit, watchUnconfBalance, false, SatoxcoinUnits::separatorAlways));
    ui->labelWatchImmature->setText(SatoxcoinUnits::formatWithUnit(unit, watchImmatureBalance, false, SatoxcoinUnits::separatorAlways));
    ui->labelWatchTotal->setText(SatoxcoinUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, SatoxcoinUnits::separatorAlways));
