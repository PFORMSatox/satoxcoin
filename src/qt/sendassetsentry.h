...
#ifndef SATOXCOIN_QT_SENDASSETSENTRY_H
#define SATOXCOIN_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending satoxcoins.
...
#endif // SATOXCOIN_QT_SENDASSETSENTRY_H
