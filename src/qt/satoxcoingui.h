...
#ifndef SATOXCOIN_QT_SATOXCOINGUI_H
#define SATOXCOIN_QT_SATOXCOINGUI_H
...
/**
  Satoxcoin GUI main class. This class represents the main window of the Satoxcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class SatoxcoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit SatoxcoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~SatoxcoinGUI();
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, SatoxcoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Satoxcoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(SatoxcoinUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // SATOXCOIN_QT_SATOXCOINGUI_H
