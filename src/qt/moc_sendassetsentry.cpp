...
void SendAssetsEntry::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SendAssetsEntry *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SendAssetsEntry::*)(SendAssetsEntry * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SendAssetsEntry::removeEntry)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SendAssetsEntry::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SendAssetsEntry::payAmountChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (SendAssetsEntry::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SendAssetsEntry::subtractFeeFromAmountChanged)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SendAssetsEntry::staticMetaObject = { {
    &QStackedWidget::staticMetaObject,
    qt_meta_stringdata_SendAssetsEntry.data,
    qt_meta_data_SendAssetsEntry,
    qt_static_metacall,
    nullptr,
    nullptr
} };
