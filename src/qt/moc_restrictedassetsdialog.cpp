...
void RestrictedAssetsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RestrictedAssetsDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (RestrictedAssetsDialog::*)(const QString & , const QString & , unsigned int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RestrictedAssetsDialog::message)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject RestrictedAssetsDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_RestrictedAssetsDialog.data,
    qt_meta_data_RestrictedAssetsDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
