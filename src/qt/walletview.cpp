...
void WalletView::setSatoxcoinGUI(SatoxcoinGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? SatoxcoinGUI::HD44_ENABLED : _walletModel->hdEnabled() ? SatoxcoinGUI::HD_ENABLED : SatoxcoinGUI::HD_DISABLED);
