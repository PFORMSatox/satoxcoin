...
void AssignQualifier::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AssignQualifier *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject AssignQualifier::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_AssignQualifier.data,
    qt_meta_data_AssignQualifier,
    qt_static_metacall,
    nullptr,
    nullptr
} };
