...
#ifndef SATOXCOIN_QT_RECEIVECOINSDIALOG_H
#define SATOXCOIN_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of satoxcoins */
...
#endif // SATOXCOIN_QT_RECEIVECOINSDIALOG_H
