...
QT_TRANSLATE_NOOP("bitcoin-core", "Error: Dumpfile version is not supported. This version of satoxcoin-wallet only supports version 1 dumpfiles. Got dumpfile with version %s"),
