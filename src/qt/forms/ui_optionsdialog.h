...
public:
    ...
    QLabel *unitLabel;
    QValueComboBox *unit;
    QHBoxLayout *horizontalLayout_DisplayCurrency;
    QLabel *currencyUnitIndexLabel;
    QValueComboBox *currencyUnitIndex;
    QHBoxLayout *horizontalLayout_3_Display;
    QLabel *thirdPartyTxUrlsLabel;
    QLineEdit *thirdPartyTxUrls;
    QPushButton *thirdPartyTxUrlsReset;
    QHBoxLayout *horizontalLayout_4_Display;
    QLabel *ipfsUrlLabel;
    QLineEdit *ipfsUrl;
    QPushButton *ipfsUrlReset;
    ...
    QPushButton *openSatoxcoinConfButton;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        satoxcoinAtStartup = new QCheckBox(tabMain);
        satoxcoinAtStartup->setObjectName(QString::fromUtf8("satoxcoinAtStartup"));

        verticalLayout_Main->addWidget(satoxcoinAtStartup);
        ...
        customFeeFeatures = new QCheckBox(groupBox);
        customFeeFeatures->setObjectName(QString::fromUtf8("customFeeFeatures"));

        verticalLayout_2->addWidget(customFeeFeatures);
        ...
        toolbarIconsOnly = new QCheckBox(tabWindow);
        toolbarIconsOnly->setObjectName(QString::fromUtf8("toolbarIconsOnly"));

        verticalLayout_Window->addWidget(toolbarIconsOnly);
        ...
        horizontalLayout_DisplayCurrency = new QHBoxLayout();
        horizontalLayout_DisplayCurrency->setObjectName(QString::fromUtf8("horizontalLayout_DisplayCurrency"));
        currencyUnitIndexLabel = new QLabel(tabDisplay);
        currencyUnitIndexLabel->setObjectName(QString::fromUtf8("currencyUnitIndexLabel"));
        currencyUnitIndexLabel->setTextFormat(Qt::PlainText);

        horizontalLayout_DisplayCurrency->addWidget(currencyUnitIndexLabel);

        currencyUnitIndex = new QValueComboBox(tabDisplay);
        currencyUnitIndex->setObjectName(QString::fromUtf8("currencyUnitIndex"));

        horizontalLayout_DisplayCurrency->addWidget(currencyUnitIndex);


        verticalLayout_Display->addLayout(horizontalLayout_DisplayCurrency);
        ...
        thirdPartyTxUrlsReset = new QPushButton(tabDisplay);
        thirdPartyTxUrlsReset->setObjectName(QString::fromUtf8("thirdPartyTxUrlsReset"));

        horizontalLayout_3_Display->addWidget(thirdPartyTxUrlsReset);
        ...
        ipfsUrlLabel = new QLabel(tabDisplay);
        ipfsUrlLabel->setObjectName(QString::fromUtf8("ipfsUrlLabel"));

        horizontalLayout_4_Display->addWidget(ipfsUrlLabel);

        ipfsUrl = new QLineEdit(tabDisplay);
        ipfsUrl->setObjectName(QString::fromUtf8("ipfsUrl"));

        horizontalLayout_4_Display->addWidget(ipfsUrl);

        ipfsUrlReset = new QPushButton(tabDisplay);
        ipfsUrlReset->setObjectName(QString::fromUtf8("ipfsUrlReset"));

        horizontalLayout_4_Display->addWidget(ipfsUrlReset);


        verticalLayout_Display->addLayout(horizontalLayout_4_Display);

        darkModeCheckBox = new QCheckBox(tabDisplay);
        darkModeCheckBox->setObjectName(QString::fromUtf8("darkModeCheckBox"));
        darkModeCheckBox->setChecked(true);

        verticalLayout_Display->addWidget(darkModeCheckBox);
        ...
        openSatoxcoinConfButton = new QPushButton(OptionsDialog);
        openSatoxcoinConfButton->setObjectName(QString::fromUtf8("openSatoxcoinConfButton"));
        openSatoxcoinConfButton->setAutoDefault(false);

        verticalLayout_Buttons->addWidget(openSatoxcoinConfButton);
        ...
        currencyUnitIndexLabel->setBuddy(currencyUnitIndex);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        satoxcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start %1 after logging in to the system.", nullptr));
#endif // QT_NO_TOOLTIP
        satoxcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start %1 on system login", nullptr));
        ...
        customFeeFeatures->setText(QApplication::translate("OptionsDialog", "Enable fee control features", nullptr));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Satoxcoin client port on the router. This only works when your router supports UPnP and it is enabled.", nullptr));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Satoxcoin network through a SOCKS5 proxy.", nullptr));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocksTor->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Satoxcoin network through a separate SOCKS5 proxy for Tor hidden services.", nullptr));
#endif // QT_NO_TOOLTIP
        connectSocksTor->setText(QApplication::translate("OptionsDialog", "Use separate SOCKS&5 proxy to reach peers via Tor hidden services:", nullptr));
        ...
        toolbarIconsOnly->setStatusTip(QApplication::translate("OptionsDialog", "Only show toolbar icons. No text.", nullptr));
#endif // QT_NO_STATUSTIP
        toolbarIconsOnly->setText(QApplication::translate("OptionsDialog", "&Icons only", nullptr));
...
#endif // QT_NO_TOOLTIP
        thirdPartyTxUrlsReset->setText(QApplication::translate("OptionsDialog", "Reset", nullptr));
#ifndef QT_NO_TOOLTIP
        ipfsUrlLabel->setToolTip(QApplication::translate("OptionsDialog", "Third party URL for IPFS-viewer. %s in the URL is replaced by IPFS hash.", nullptr));
#endif // QT_NO_TOOLTIP
        ipfsUrlLabel->setText(QApplication::translate("OptionsDialog", "IPFS Viewer URL", nullptr));
#ifndef QT_NO_TOOLTIP
        ipfsUrl->setToolTip(QApplication::translate("OptionsDialog", "Third party URL for IPFS-viewer. %s in the URL is replaced by IPFS hash.", nullptr));
#endif // QT_NO_TOOLTIP
        ipfsUrlReset->setText(QApplication::translate("OptionsDialog", "Reset", nullptr));
        darkModeCheckBox->setText(QApplication::translate("OptionsDialog", "Enable Dark Mode", nullptr));
...
#ifndef QT_NO_TOOLTIP
        openSatoxcoinConfButton->setToolTip(QApplication::translate("OptionsDialog", "Open the %1 configuration file from the working directory.", nullptr));
#endif // QT_NO_TOOLTIP
        openSatoxcoinConfButton->setText(QApplication::translate("OptionsDialog", "Open Configuration File", nullptr));
#ifndef QT_NO_TOOLTIP
