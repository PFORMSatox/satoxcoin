...
public:
    ...
    QLabel *label2_repair_zap1;
    QLabel *label_repair_reindex;
    QLabel *label2_repair_reindex;
    ...
    void setupUi(QWidget *RPCConsole)
    {
        ...
        label_repair_header->setGeometry(QRect(20, 15, 711, 16));
        ...
        label_repair_helptext->setGeometry(QRect(20, 35, 950, 41));
        QFont font3;
        font3.setBold(false);
        font3.setWeight(50);
        ...
        wallet_path->setGeometry(QRect(20, 75, 750, 21));
        btn_rescan = new QPushButton(tab_repair);
        btn_rescan->setObjectName(QString::fromUtf8("btn_rescan"));
        btn_rescan->setGeometry(QRect(15, 121, 240, 28));
        btn_zapwallettxes1 = new QPushButton(tab_repair);
        btn_zapwallettxes1->setObjectName(QString::fromUtf8("btn_zapwallettxes1"));
        btn_zapwallettxes1->setGeometry(QRect(15, 181, 240, 28));
        btn_reindex = new QPushButton(tab_repair);
        btn_reindex->setObjectName(QString::fromUtf8("btn_reindex"));
        btn_reindex->setGeometry(QRect(15, 246, 240, 28));
        label_repair_rescan = new QLabel(tab_repair);
        label_repair_rescan->setObjectName(QString::fromUtf8("label_repair_rescan"));
        label_repair_rescan->setGeometry(QRect(265, 120, 700, 28));
        label_repair_zap1 = new QLabel(tab_repair);
        label_repair_zap1->setObjectName(QString::fromUtf8("label_repair_zap1"));
        label_repair_zap1->setGeometry(QRect(265, 170, 700, 28));
        label2_repair_zap1 = new QLabel(tab_repair);
        label2_repair_zap1->setObjectName(QString::fromUtf8("label2_repair_zap1"));
        label2_repair_zap1->setGeometry(QRect(265, 190, 700, 28));
        label_repair_reindex = new QLabel(tab_repair);
        label_repair_reindex->setObjectName(QString::fromUtf8("label_repair_reindex"));
        label_repair_reindex->setGeometry(QRect(265, 235, 700, 28));
        label2_repair_reindex = new QLabel(tab_repair);
        label2_repair_reindex->setObjectName(QString::fromUtf8("label2_repair_reindex"));
        label2_repair_reindex->setGeometry(QRect(265, 255, 700, 28));
    ...
    void retranslateUi(QWidget *RPCConsole)
    {
        ...
        label_repair_helptext->setText(QApplication::translate("RPCConsole", "The buttons below will restart the wallet with command-line options to recover missing transactions or rebuild corrupt blockchain files.", nullptr));
        ...
        btn_zapwallettxes1->setText(QApplication::translate("RPCConsole", "Recover transactions", nullptr));
        btn_reindex->setText(QApplication::translate("RPCConsole", "Rebuild index", nullptr));
        label_repair_rescan->setText(QApplication::translate("RPCConsole", "-rescan: Rescan the blockchain files on disk for missing wallet transactions. (Short process)", nullptr));
        label_repair_zap1->setText(QApplication::translate("RPCConsole", "-zapwallettxes=1: Delete all wallet transactions and recover them with a rescan. (Keeps metadata)", nullptr));
        label2_repair_zap1->setText(QApplication::translate("RPCConsole", "Use to recover balance when transactions fail to broadcast to the network.", nullptr));
        label_repair_reindex->setText(QApplication::translate("RPCConsole", "-reindex: Rebuild chain state and block index from the blk00*.dat files on disk. (Long process)", nullptr));
        label2_repair_reindex->setText(QApplication::translate("RPCConsole", "Use after importing private keys or restoring a wallet.dat backup.", nullptr));
