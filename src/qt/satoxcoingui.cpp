...
const std::string SatoxcoinGUI::DEFAULT_UIPLATFORM =
...
SatoxcoinGUI::SatoxcoinGUI(interfaces::Node& node, const PlatformStyle *_platformStyle, const NetworkStyle *networkStyle, QWidget *parent) :
    QMainWindow(parent),
    m_node(node),
    ...
    m_network_style(networkStyle)
{
    ...
    if(enableWallet)
    {
        ...
        connect(walletFrame, &WalletFrame::createWalletButtonClicked, this, &SatoxcoinGUI::createWallet);
    ...
    connect(labelBlocksIcon, &GUIUtil::ClickableLabel::clicked, this, &SatoxcoinGUI::showModalOverlay);
    connect(progressBar, &GUIUtil::ClickableProgressBar::clicked, this, &SatoxcoinGUI::showModalOverlay);
...
void SatoxcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and satoxcoin: URIs)"));
    ...
    connect(overviewAction, &QAction::triggered, this, &SatoxcoinGUI::gotoOverviewPage);
    connect(sendCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(sendCoinsAction, &QAction::triggered, [this]{ gotoSendCoinsPage(); });
    connect(receiveCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(receiveCoinsAction, &QAction::triggered, this, &SatoxcoinGUI::gotoReceiveCoinsPage);
    connect(historyAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(historyAction, &QAction::triggered, this, &SatoxcoinGUI::gotoHistoryPage);
#endif // ENABLE_WALLET
    ...
    openAction->setStatusTip(tr("Open a satoxcoin: URI"));
    ...
    connect(quitAction, &QAction::triggered, this, &SatoxcoinGUI::quitRequested);
    connect(aboutAction, &QAction::triggered, this, &SatoxcoinGUI::aboutClicked);
    connect(aboutQtAction, &QAction::triggered, qApp, QApplication::aboutQt);
    connect(optionsAction, &QAction::triggered, this, &SatoxcoinGUI::optionsClicked);
    connect(showHelpMessageAction, &QAction::triggered, this, &SatoxcoinGUI::showHelpMessageClicked);
    connect(openRPCConsoleAction, &QAction::triggered, this, &SatoxcoinGUI::showDebugWindow);
    ...
    if(walletFrame)
    {
        ...
        connect(openAction, &QAction::triggered, this, &SatoxcoinGUI::openClicked);
        connect(m_open_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [path, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, path] {
                    ...
                    connect(activity, &OpenWalletActivity::opened, this, &SatoxcoinGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_restore_wallet_action, &QAction::triggered, [this] {
            ...
            connect(activity, &RestoreWalletActivity::restored, this, &SatoxcoinGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_create_wallet_action, &QAction::triggered, this, &SatoxcoinGUI::createWallet);
        ...
        connect(m_migrate_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [wallet_name, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, wallet_name] {
                    ...
                    connect(activity, &MigrateWalletActivity::migrated, this, &SatoxcoinGUI::setCurrentWallet);
        ...
        connect(m_mask_values_action, &QAction::toggled, this, &SatoxcoinGUI::setPrivacy);
        connect(m_mask_values_action, &QAction::toggled, this, &SatoxcoinGUI::enableHistoryAction);
    }
#endif // ENABLE_WALLET

    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_C), this), &QShortcut::activated, this, &SatoxcoinGUI::showDebugWindowActivateConsole);
    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_D), this), &QShortcut::activated, this, &SatoxcoinGUI::showDebugWindow);
}

void SatoxcoinGUI::createMenuBar()
{
    appMenuBar = menuBar();
...
void SatoxcoinGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        connect(m_wallet_selector, qOverload<int>(&QComboBox::currentIndexChanged), this, &SatoxcoinGUI::setCurrentWalletBySelectorIndex);
...
void SatoxcoinGUI::setClientModel(ClientModel *_clientModel, interfaces::BlockAndHeaderTipInfo* tip_info)
{
    ...
    if(_clientModel)
    {
        ...
        connect(_clientModel, &ClientModel::numConnectionsChanged, this, &SatoxcoinGUI::setNumConnections);
        connect(_clientModel, &ClientModel::networkActiveChanged, this, &SatoxcoinGUI::setNetworkActive);
        ...
        connect(_clientModel, &ClientModel::numBlocksChanged, this, &SatoxcoinGUI::setNumBlocks);
        ...
        connect(_clientModel, &ClientModel::showProgress, this, &SatoxcoinGUI::showProgress);
...
#ifdef ENABLE_WALLET
void SatoxcoinGUI::enableHistoryAction(bool privacy)
{
...
void SatoxcoinGUI::setWalletController(WalletController* wallet_controller, bool show_loading_minimized)
{
    ...
    GUIUtil::ExceptionSafeConnect(wallet_controller, &WalletController::walletAdded, this, &SatoxcoinGUI::addWallet);
    connect(wallet_controller, &WalletController::walletRemoved, this, &SatoxcoinGUI::removeWallet);
...
WalletController* SatoxcoinGUI::getWalletController()
{
    return m_wallet_controller;
}

void SatoxcoinGUI::addWallet(WalletModel* walletModel)
{
    ...
    connect(wallet_view, &WalletView::outOfSyncWarningClicked, this, &SatoxcoinGUI::showModalOverlay);
    connect(wallet_view, &WalletView::transactionClicked, this, &SatoxcoinGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::coinsSent, this, &SatoxcoinGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        this->message(title, message, style);
    });
    connect(wallet_view, &WalletView::encryptionStatusChanged, this, &SatoxcoinGUI::updateWalletStatus);
    connect(wallet_view, &WalletView::incomingTransaction, this, &SatoxcoinGUI::incomingTransaction);
    connect(this, &SatoxcoinGUI::setPrivacy, wallet_view, &WalletView::setPrivacy);
    wallet_view->setPrivacy(isPrivacyModeActivated());
    const QString display_name = walletModel->getDisplayName();
    m_wallet_selector->addItem(display_name, QVariant::fromValue(walletModel));
}

void SatoxcoinGUI::removeWallet(WalletModel* walletModel)
{
...
void SatoxcoinGUI::setCurrentWallet(WalletModel* wallet_model)
{
    if (!walletFrame || !m_wallet_controller) return;
...
void SatoxcoinGUI::setCurrentWalletBySelectorIndex(int index)
{
    WalletModel* wallet_model = m_wallet_selector->itemData(index).value<WalletModel*>();
    if (wallet_model) setCurrentWallet(wallet_model);
}

void SatoxcoinGUI::removeAllWallets()
{
    if(!walletFrame)
        return;
    setWalletActionsEnabled(false);
...
void SatoxcoinGUI::setWalletActionsEnabled(bool enabled)
{
...
void SatoxcoinGUI::createTrayIcon()
{
...
void SatoxcoinGUI::createTrayIconMenu()
{
#ifndef Q_OS_MACOS
    if (!trayIcon) return;
#endif // Q_OS_MACOS
    ...
    show_hide_action = trayIconMenu->addAction(QString(), this, &SatoxcoinGUI::toggleHidden);
...
void SatoxcoinGUI::optionsClicked()
{
    openOptionsDialogWithTab(OptionsDialog::TAB_MAIN);
}

void SatoxcoinGUI::aboutClicked()
{
    if(!clientModel)
        return;
...
void SatoxcoinGUI::showDebugWindow()
{
    GUIUtil::bringToFront(rpcConsole);
    Q_EMIT consoleShown(rpcConsole);
}

void SatoxcoinGUI::showDebugWindowActivateConsole()
{
    rpcConsole->setTabFocus(RPCConsole::TabTypes::CONSOLE);
    showDebugWindow();
}

void SatoxcoinGUI::showHelpMessageClicked()
{
    GUIUtil::bringToFront(helpMessageDialog);
}

#ifdef ENABLE_WALLET
void SatoxcoinGUI::openClicked()
{
...
void SatoxcoinGUI::gotoOverviewPage()
{
    overviewAction->setChecked(true);
    if (walletFrame) walletFrame->gotoOverviewPage();
}

void SatoxcoinGUI::gotoHistoryPage()
{
    historyAction->setChecked(true);
    if (walletFrame) walletFrame->gotoHistoryPage();
}

void SatoxcoinGUI::gotoReceiveCoinsPage()
{
    receiveCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoReceiveCoinsPage();
}

void SatoxcoinGUI::gotoSendCoinsPage(QString addr)
{
    sendCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoSendCoinsPage(addr);
}

void SatoxcoinGUI::gotoSignMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoSignMessageTab(addr);
}

void SatoxcoinGUI::gotoVerifyMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoVerifyMessageTab(addr);
}
void SatoxcoinGUI::gotoLoadPSBT(bool from_clipboard)
{
    if (walletFrame) walletFrame->gotoLoadPSBT(from_clipboard);
}
#endif // ENABLE_WALLET

void SatoxcoinGUI::updateNetworkState()
{
...
void SatoxcoinGUI::setNumConnections(int count)
{
    updateNetworkState();
}

void SatoxcoinGUI::setNetworkActive(bool network_active)
{
    updateNetworkState();
...
void SatoxcoinGUI::updateHeadersSyncProgressLabel()
{
...
void SatoxcoinGUI::updateHeadersPresyncProgressLabel(int64_t height, const QDateTime& blockDate)
{
...
void SatoxcoinGUI::openOptionsDialogWithTab(OptionsDialog::Tab tab)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;

    auto dlg = new OptionsDialog(this, enableWallet);
    connect(dlg, &OptionsDialog::quitOnReset, this, &SatoxcoinGUI::quitRequested);
...
void SatoxcoinGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, SyncType synctype, SynchronizationState sync_state)
{
...
void SatoxcoinGUI::createWallet()
{
#ifdef ENABLE_WALLET
    auto activity = new CreateWalletActivity(getWalletController(), this);
    connect(activity, &CreateWalletActivity::created, this, &SatoxcoinGUI::setCurrentWallet);
    connect(activity, &CreateWalletActivity::created, rpcConsole, &RPCConsole::setCurrentWallet);
    activity->create();
#endif // ENABLE_WALLET
}

void SatoxcoinGUI::message(const QString& title, QString message, unsigned int style, bool* ret, const QString& detailed_message)
{
...
void SatoxcoinGUI::changeEvent(QEvent *e)
{
    ...
    if(e->type() == QEvent::WindowStateChange)
    {
        if(clientModel && clientModel->getOptionsModel() && clientModel->getOptionsModel()->getMinimizeToTray())
        {
            ...
            {
                QTimer::singleShot(0, this, &SatoxcoinGUI::hide);
                e->ignore();
            }
            else if((wsevt->oldState() & Qt::WindowMinimized) && !isMinimized())
            {
                QTimer::singleShot(0, this, &SatoxcoinGUI::show);
                e->ignore();
            }
        }
    }
...
void SatoxcoinGUI::closeEvent(QCloseEvent *event)
{
#ifndef Q_OS_MACOS // Ignored on Mac
    if(clientModel && clientModel->getOptionsModel())
    {
...
void SatoxcoinGUI::showEvent(QShowEvent *event)
{
...
#ifdef ENABLE_WALLET
void SatoxcoinGUI::incomingTransaction(const QString& date, SatoxcoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName)
{
    // On new transaction, make an info balloon
    QString msg = tr("Date: %1\n").arg(date) +
                  tr("Amount: %1\n").arg(SatoxcoinUnits::formatWithUnit(unit, amount, true));
...
void SatoxcoinGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void SatoxcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
...
bool SatoxcoinGUI::eventFilter(QObject *object, QEvent *event)
{
...
#ifdef ENABLE_WALLET
bool SatoxcoinGUI::handlePaymentRequest(const SendCoinsRecipient& recipient)
{
    // URI has to be valid
...
void SatoxcoinGUI::setHDStatus(bool privkeyDisabled, int hdEnabled)
{
...
void SatoxcoinGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void SatoxcoinGUI::updateWalletStatus()
{
    assert(walletFrame);
...
void SatoxcoinGUI::updateProxyIcon()
{
    std::string ip_port;
...
void SatoxcoinGUI::updateWindowTitle()
{
...
void SatoxcoinGUI::showNormalIfMinimized(bool fToggleHidden)
{
    if(!clientModel)
        return;
...
void SatoxcoinGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void SatoxcoinGUI::detectShutdown()
{
...
void SatoxcoinGUI::showProgress(const QString &title, int nProgress)
{
    if (nProgress == 0) {
...
void SatoxcoinGUI::showModalOverlay()
{
    if (modalOverlay && (progressBar->isVisible() || modalOverlay->isLayerVisible()))
        modalOverlay->toggleVisibility();
}

static bool ThreadSafeMessageBox(SatoxcoinGUI* gui, const bilingual_str& message, unsigned int style)
{
    ...
    if (message.original != message.translated) {
        detailed_message = SatoxcoinGUI::tr("Original message:") + "\n" + QString::fromStdString(message.original);
    }
...
void SatoxcoinGUI::subscribeToCoreSignals()
{
...
void SatoxcoinGUI::unsubscribeFromCoreSignals()
{
...
bool SatoxcoinGUI::isPrivacyModeActivated() const
{
    ...
    : m_platform_style{platformStyle}
{
    ...
    QList<SatoxcoinUnit> units = SatoxcoinUnits::availableUnits();
    int max_width = 0;
    const QFontMetrics fm(font());
    for (const SatoxcoinUnit unit : units) {
        max_width = qMax(max_width, GUIUtil::TextWidth(fm, SatoxcoinUnits::longName(unit)));
    }
...
{
    menu = new QMenu(this);
    for (const SatoxcoinUnit u : SatoxcoinUnits::availableUnits()) {
        menu->addAction(SatoxcoinUnits::longName(u))->setData(QVariant::fromValue(u));
    }
...
void UnitDisplayStatusBarControl::updateDisplayUnit(SatoxcoinUnit newUnits)
{
    setText(SatoxcoinUnits::longName(newUnits));
}
