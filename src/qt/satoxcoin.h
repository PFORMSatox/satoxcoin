...
#ifndef SATOXCOIN_QT_SATOXCOIN_H
#define SATOXCOIN_QT_SATOXCOIN_H
...
Q_SIGNALS:
    ...
    void windowShown(SatoxcoinGUI* window);
...
#endif // SATOXCOIN_QT_SATOXCOIN_H
