...
#ifndef SATOXCOIN_QT_GUIUTIL_H
#define SATOXCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Satoxcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "satoxcoin:" URI into recipient object, return true on successful parsing
