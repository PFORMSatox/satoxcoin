...
#ifndef SATOXCOIN_QT_OPTIONSMODEL_H
#define SATOXCOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Satoxcoin client.
...
public:
    ...
    SatoxcoinUnit getDisplayUnit() const { return m_display_satoxcoin_unit; }
...
private:
    ...
    QString language;
    SatoxcoinUnit m_display_satoxcoin_unit;
...
#endif // SATOXCOIN_QT_OPTIONSMODEL_H
