    ...
    mapper(0)
{
    ...
    ui->satoxcoinAtStartup->setToolTip(ui->satoxcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->satoxcoinAtStartup->setText(ui->satoxcoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openSatoxcoinConfButton->setToolTip(ui->openSatoxcoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new SatoxcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->satoxcoinAtStartup, OptionsModel::StartAtStartup);
