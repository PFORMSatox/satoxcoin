...
#ifndef SATOXCOIN_SCRIPT_STANDARD_H
#define SATOXCOIN_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_SATOXCOIN_ASSET script that carries data
    /** RVN END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a satoxcoin address
 */
...
/**
 * Generate a Satoxcoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // SATOXCOIN_SCRIPT_STANDARD_H
