...
#ifndef SATOXCOIN_SCRIPT_SCRIPT_H
#define SATOXCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Satoxcoin always counted CHECKMULTISIGs
...
#endif // SATOXCOIN_SCRIPT_SCRIPT_H
