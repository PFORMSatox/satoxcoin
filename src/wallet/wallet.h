...
#ifndef SATOXCOIN_WALLET_WALLET_H
#define SATOXCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this satoxcoin node, and set to 0 for transactions that were created
...
#endif // SATOXCOIN_WALLET_WALLET_H
