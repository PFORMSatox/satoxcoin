...
RPCHelpMan distributereward()
{
    return RPCHelpMan{
        ...
        "Requires wallet passphrase to be set with walletpassphrase call if wallet is encrypted.\n",
        {
            ...
            {"distribution_asset_name", RPCArg::Type::STR, RPCArg::Optional::NO, "the name of the asset that will be distributed, or SATOX"},
        ...
        RPCExamples{
            HelpExampleCli("distributereward", "\"ASSET_NAME\" 12345 \"SATOX\" 1000")
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
        {
            ...
            if (!request.params[5].isNull()) {
                ...
                if (!change_address.empty() && !IsValidDestinationString(change_address))
                    throw JSONRPCError(RPC_INVALID_PARAMETER, std::string("Invalid change address: Use a valid SATOX address"));
            }
            ...
            bool isSATOX = (distribution_asset_name == NATIVE_ASSET_TICKER);
            int batchNumber = 0;
            ...
            for (size_t i = 0; i < vecDistributionList.size(); i += MAX_PAYMENTS_PER_TRANSACTION) {
                ...
                if (isSATOX) {
                    // SATOX distribution: use standard SendMoney
