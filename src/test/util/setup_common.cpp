...
{
    // satoxcoin regtest genesis is at 1661734578 (2022-08-29). Mock time must
    // be after genesis or mined blocks are rejected as time-too-old.
    SetMockTime(1661734578 + 60);
    ...
    {
        LOCK(::cs_main);
        // sanity: the tip must advance past genesis
