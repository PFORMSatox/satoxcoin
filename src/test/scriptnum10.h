...
#ifndef SATOXCOIN_TEST_SCRIPTNUM10_H
#define SATOXCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Satoxcoin Core 0.10.0, for cross-comparison.
 */
public:
